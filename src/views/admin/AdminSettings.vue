...
<template>
  <div class="admin-settings">
    <header class="mb-4">
      <h1 class="page-title mb-1">⚙️ Settings</h1>
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <div class="card-crypto p-3 p-md-4 h-100">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="text-emphasis mb-0">🗄 Database</h6>
      ...
      <div class="col-md-6">
        <div class="card-crypto p-3 p-md-4 h-100">
          <h6 class="text-emphasis mb-3">👤 Your account</h6>
          <div class="bin-stats-compact mt-0">
            <div class="bin-stat">
      ...
      <div class="col-md-6">
        <div class="card-crypto p-3 p-md-4 h-100">
          <h6 class="text-emphasis mb-3">🎨 Preferences</h6>
      ...
      <div class="col-12">
        <div class="card-crypto p-3 p-md-4">
          <div class="d-flex justify-content-between align-items-center mb-2">
            <h6 class="text-emphasis mb-0">🧠 RAG pipeline</h6>
